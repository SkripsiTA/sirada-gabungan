...
class DataSuratController extends Controller
{
    ...
    public function show_kode_surat_non_panitia($id) {
        $data = NomorSurat::where('desa_adat_id', $id)
                    ->where('keterangan', 'not like', '%Panitia%')
                    ->where('keterangan', 'not like', '%Panitia')
                    ->where('keterangan', 'not like', 'Panitia%')
                    ->get();
        $data_cek = NomorSurat::where('desa_adat_id', $id)
                    ->where('keterangan', 'not like', '%Panitia%')
                    ->where('keterangan', 'not like', '%Panitia')
                    ->where('keterangan', 'not like', 'Panitia%')
                    ->first();
    ...
    public function up_surat_keluar_non_panitia(Request $request) {
        ...
        $master_surat = NomorSurat::where('kode_nomor_surat', $request->master_surat)->first();
    ...
    public function simpan_surat_masuk(Request $request) {
        ...
        if($request->hasFile('surat')) {
            ...
            $file->move('assets/file/surat-masuk', $file_name);
            ...
            $surat_masuk->file = $file->getClientOriginalName();
