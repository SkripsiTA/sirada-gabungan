...
class RegistrasiController extends Controller
{
    ...
    public function proses_registrasi() {
        ...
        $cek_nomor_telepon = User::select('nomor_telepon')->where('nomor_telepon', Request()->nomor_telepon)->first();
        $cek_username = User::select('username')->where('username', Request()->username)->first();
        $data = [
