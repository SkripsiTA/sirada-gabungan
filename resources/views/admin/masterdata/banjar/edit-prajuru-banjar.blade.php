      ...
      <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card">
                ...
                <form action="{{ route('update-prajuru-banjar-adat', $editprajurubanjar->prajuru_banjar_adat_id) }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="card-body">
                      ...
                      <div class="pl-lg-4">
                          <div class="row">
                              ...
                              <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select name="nama_jabatan" class="form-control" id="nama_jabatan" required>
                                        <option value="{{ $editprajurubanjar->jabatan }}">{{ $editprajurubanjar->jabatan }}</option>
                              ...
                              <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select name="status_prajuru_banjar" class="form-control" id="status_prajuru_banjar" required>
                                        <option value="{{ $editprajurubanjar->status_prajuru_banjar_adat }}">{{ $editprajurubanjar->status_prajuru_banjar_adat }}</option>
                              ...
                              <div class="col-lg-12">
                                ...
                                <input type="file" name="file_sk" class="form-control" placeholder="File SK" value="{{ $editprajurubanjar->sk_prajuru_banjar }}">
                                </div>
                              </div>
                          </div>
                      </div>
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" class="form-control" id="email" placeholder="Email" value="{{ $editprajurubanjar->kramamipil->cacahkramamipil->penduduk->user[0]->email }}" required>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="input-username">Nomor Telpon<i class="text-danger text-sm text-bold">*</i></label>
                                    <input type="text" name="nomor_telepon" class="form-control" id="nomor_telepon" placeholder="Nomor Telpon" value="{{ $editprajurubanjar->kramamipil->cacahkramamipil->penduduk->user[0]->nomor_telepon }}" required>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    {{--  <label class="form-control-label" for="input-email">Password</label>  --}}
                                    <input type="hidden" name="password" class="password form-control" id="password" placeholder="Password" value="{{ $editprajurubanjar->kramamipil->cacahkramamipil->penduduk->user[0]->password }}" readonly>
                                </div>
                            </div>
                        </div>
                      </div>
