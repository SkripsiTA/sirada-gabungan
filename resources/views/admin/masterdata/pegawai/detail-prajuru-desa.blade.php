                      ...
                      <div class="pl-lg-4">
                          <div class="row">
                              ...
                              <div class="col-lg-12">
                                ...
                                <input type="text" name="file_sk" class="form-control" placeholder="SK Prajuru Desa Adat" value="{{ $detailprajurudesa->sk_prajuru }}" disabled><iframe src="{{ asset('assets/img/SK/'.$detailprajurudesa->sk_prajuru ) }}"  height="500px" width="100%" style="margin-Top :5px;"></iframe>
                                </div>
                              </div>
                          </div>
                      </div>
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" class="form-control" id="email" placeholder="Email" value="{{ $detailprajurudesa->kramamipil->cacahkramamipil->penduduk->user[0]->email }}" readonly>
                                </div>
                            </div>
                            <div class="col-lg-4">
                              <div class="form-group">
                                  <label class="form-control-label" for="input-username">Nomor Telpon<i class="text-danger text-sm text-bold">*</i></label>
                                  <input type="text" name="nomor_telepon" class="form-control" id="nomor_telepon" placeholder="Nomor Telpon" value="{{ $detailprajurudesa->kramamipil->cacahkramamipil->penduduk->user[0]->nomor_telepon }}" readonly>
                              </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label" for="input-email">Password</label>
                                    <input type="password" name="password" class="password form-control" id="password" placeholder="Password" value="{{ $detailprajurudesa->kramamipil->cacahkramamipil->penduduk->user[0]->password }}" readonly>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select name="role_prajuru" class="form-control" id="role_prajuru" readonly>
                                        <option value="{{ $detailprajurudesa->desaadat->user[0]->role }}" selected>{{ $detailprajurudesa->kramamipil->cacahkramamipil->penduduk->user[0]->role }}</option>
