                      ...
                      <div class="pl-lg-4">
                          <div class="row">
                              ...
                              <div class="col-lg-12">
                                ...
                                <input type="file" name="file_sk" class="form-control" placeholder="File SK" value="{{ $editprajurudesa->sk_prajuru }}">
                                </div>
                              </div>
                          </div>
                      </div>
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" class="form-control" id="email" placeholder="Email" value="{{ $editprajurudesa->kramamipil->cacahkramamipil->penduduk->user[0]->email }}" required>
                                </div>
                            </div>
                            <div class="col-lg-4">
                              <div class="form-group">
                                  <label class="form-control-label" for="input-username">Nomor Telpon<i class="text-danger text-sm text-bold">*</i></label>
                                  <input type="text" name="nomor_telepon" class="form-control" id="nomor_telepon" placeholder="Nomor Telpon" value="{{ $editprajurudesa->kramamipil->cacahkramamipil->penduduk->user[0]->nomor_telepon }}" required>
                              </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label" for="input-email">Password</label>
                                    <input type="password" name="password" class="password form-control" id="password" placeholder="Password" value="{{ $editprajurudesa->kramamipil->cacahkramamipil->penduduk->user[0]->password }}" required>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select name="role_prajuru" class="form-control" id="role_prajuru" required>
                                        <option value="{{ $editprajurudesa->kramamipil->cacahkramamipil->penduduk->user[0]->role }}" selected>{{ $editprajurudesa->kramamipil->cacahkramamipil->penduduk->user[0]->role }}</option>
