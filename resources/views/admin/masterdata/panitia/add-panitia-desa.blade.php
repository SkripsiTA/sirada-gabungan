      ...
      <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card">
                ...
                <form action="{{ route('add-panitia-desa-adat') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="card-body">
                    ...
                    <div class="card-footer text-right">
                        <a href="{{ route('panitia-desa-adat') }}" type="button" class="btn btn-secondary">Batal</a>
