      ...
      <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card">
                ...
                <form action="<?php echo e(route('update-surat-keluar-non-panitia', $suratkeluarnonpanitia->surat_keluar_id)); ?>" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="row">
                              <div class="col-lg-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nomor_surat_keluar" class="form-control" placeholder="otomatis" value="<?php echo e($suratkeluarnonpanitia->nomor_surat); ?>">
                                </div>
                              </div>
                              <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="input-email">Lepihan<i class="text-danger text-sm text-bold">*</i></label>
                                    <input type="number" name="lepihan" class="form-control" id="lepihan" placeholder="Lepihan" value="<?php echo e($suratkeluarnonpanitia->lepihan); ?>">
                                </div>
                              </div>
                              <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label" for="input-email">Parindikan<i class="text-danger text-sm text-bold">*</i></label>
                                    <input type="text" name="parindikan" class="form-control" id="parindikan" placeholder="Parindikan" value="<?php echo e($suratkeluarnonpanitia->parindikan); ?>">
                                </div>
                              </div>
                              <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label" for="input-email">Tetujon<i class="text-danger text-sm text-bold">*</i></label>
                                    <input type="text" name="tetujon" class="form-control" id="tetujon" placeholder="Tetujon" value="<?php echo e($suratkeluarnonpanitia->pihak_penerima); ?>">
                                </div>
                              </div>
                          </div>
                      </div>
                        ...
                        <div class="row">
                          <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea rows="4" name="pemahbah_surat" class="form-control" placeholder="Pemahbah Surat"><?php echo e($suratkeluarnonpanitia->pamahbah_surat); ?></textarea>
                            </div>
                          </div>
                          <div class="col-lg-12">
                              <div class="form-group">
                                  <label class="form-control-label" for="input-username">Daging Surat</label>
                                  <textarea rows="4" name="daging_surat" class="form-control" placeholder="Daging Surat"><?php echo e($suratkeluarnonpanitia->daging_surat); ?></textarea>
                              </div>
                          </div>
                          <div class="col-lg-12">
                            <div class="form-group">
                                <label class="form-control-label" for="input-username">Pamuput Surat</label>
                                <textarea rows="4" name="pamuput_surat" class="form-control" placeholder="Pamuput Surat"><?php echo e($suratkeluarnonpanitia->pamuput_surat); ?></textarea>
                            </div>
                          </div>
                          <div class="col-lg-12">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" name="tanggal_kegiatan_mulai" placeholder="Tanggal Kegiatan Mulai" type="text" value="<?php echo e($suratkeluarnonpanitia->tanggal_kegiatan_mulai); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" name="tanggal_kegiatan_berakhir" placeholder="Tanggal Kegiatan Selesai" type="text" value="<?php echo e($suratkeluarnonpanitia->tanggal_kegiatan_berakhir); ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                          ...
                          <div class="col-lg-4">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        <input type="time" name="waktu_kegiatan_mulai" class="form-control" id="waktu_kegiatan" placeholder="Waktu Kegiatan Mulai" value="<?php echo e($suratkeluarnonpanitia->waktu_kegiatan_mulai); ?>">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <input type="time" name="waktu_kegiatan_berakhir" class="form-control" id="waktu_kegiatan" placeholder="Waktu Kegiatan Selesai" value="<?php echo e($suratkeluarnonpanitia->waktu_kegiatan_selesai); ?>">
                                    </div>
                                </div>
                              </div>
                            </div>
                          <div class="col-lg-8">
                            <div class="form-group">
                                ...
                                <input type="text" name="busana" class="form-control" id="busana" placeholder="Busana/Pakaian" value="<?php echo e($suratkeluarnonpanitia->busana); ?>">
                            </div>
                          </div>
                          <div class="col-lg-12">
                            <div class="form-group">
                                <label class="form-control-label" for="input-email">Tempat Kegiatan</label>
                                <input type="text" name="tempat_kegiatan" class="form-control" id="tempat_kegiatan" placeholder="Tempat Kegiatan" value="<?php echo e($suratkeluarnonpanitia->tempat_kegiatan); ?>">
                            </div>
                          </div>
                          <div class="col-lg-12">
                            <div class="form-group">
                            ...
                            <input type="file" name="lepihan_surat" class="form-control" placeholder="Lepihan Surat" value="<?php echo e($suratkeluarnonpanitia->lampiran); ?>" accept="application/pdf">
                            </div>
                        </div>
                        </div>
                      </div>
                          ...
                          <div class="row">
                              <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tumusan" class="form-control" id="tumusan" placeholder="Tumusan" value="<?php echo e($suratkeluarnonpanitia->tumusan); ?>">
                                </div>
                              </div>
                          </div>
                      </div>
...
<?php /**PATH D:\Teknologi Informasi\Tugas Akhir\PROJECT\SirajaProject\SirajaProject\resources\views/admin/suratkeluar/suratNonPanitia/edit-surat-non-panitia.blade.php ENDPATH**/ ?>