                ...
                <div class="card-header">
                    <div class="col-lg-12">
                        ...
                        <div class="float-right">
                            <a href="<?php echo e(route('cetak-daftar-surat-keluar-panitia')); ?>" type="button" class="btn btn-md btn-danger" target="_blank"><i class="fa fa-print"></i>
                            PDF</a>
                            <a href="<?php echo e(route('create-surat-keluar-panitia')); ?>" type="button" class="btn btn-md btn-primary"><i class="fa fa-plus"></i>
                            Tambah</a>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <table class="table align-items-center table-flush">
                                                ...
                                                <?php
                                                    $i = 1;
                                                ?>
                                                <?php $__currentLoopData = $suratkeluarwaiting; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($data->desa_adat_id == Auth::user()->desa_adat_id): ?>
                                                <tr>
                                                    <td> <?php echo e($i++); ?> </td>
                                                    <td><?php echo e($data->nomor_surat); ?></td>
                                                    <th scope="row"><?php echo e($data->parindikan); ?></th>
                                                    <td>
                                                        <span class="badge badge-pill badge-warning"><?php echo e($data->status); ?></span>
                                                    </td>
                                                    <?php if($data->created_at == null): ?>
                                                        <td><?php echo e($data->created_at); ?></td>
                                                    <?php else: ?>
                                                        <td><?php echo e(showDateTime($data->created_at, 'd F Y')); ?></td>
                                                    <?php endif; ?>
                                                    <td><?php echo e($data->pihak_penerima); ?></td>
                                                    <td><?php echo e($data->tim_kegiatan); ?></td>
                                                    <td class="text-right">
                                                        <a href="<?php echo e(route('detail-surat-keluar-panitia', $data->surat_keluar_id)); ?>" class="btn btn-sm btn-flat btn-primary"><i class="fa fa-eye"></i></a>
                                                    </td>
                                            ...
                                            <div class="card-footer py-4">
                                                <?php echo e($suratkeluarwaiting->links('vendor.pagination.bootstrap-4')); ?>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="card">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table align-items-center table-flush">
                                                    ...
                                                    <?php
                                                        $i = 1;
                                                    ?>
                                                    <?php $__currentLoopData = $suratkeluarinprogress; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($data->desa_adat_id == Auth::user()->desa_adat_id): ?>
                                                    <tr>
                                                        <td> <?php echo e($i++); ?> </td>
                                                        <td><?php echo e($data->nomor_surat); ?></td>
                                                        ...
                                                        <td><?php echo e($data->tim_kegiatan); ?></td>
                                                        <td class="text-right">
                                                            <a href="<?php echo e(route('detail-surat-keluar-panitia-inprogress', $data->surat_keluar_id)); ?>" class="btn btn-sm btn-flat btn-primary"><i class="fa fa-eye"></i></a>
                                                        </td>
                                            ...
                                            <!-- Card footer -->
                                            <div class="card-footer py-4">
                                                <?php echo e($suratkeluarinprogress->links('vendor.pagination.bootstrap-4')); ?>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="card">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table align-items-center table-flush">
                                                    ...
                                                    <?php
                                                        $i = 1;
                                                    ?>
                                                    <?php $__currentLoopData = $suratkeluarverified; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($data->desa_adat_id == Auth::user()->desa_adat_id): ?>
                                                    <tr>
                                                        <td> <?php echo e($i++); ?> </td>
                                                        <td><?php echo e($data->nomor_surat); ?></td>
                                                        ...
                                                        <?php else: ?>
                                                            <td><?php echo e(showDateTime($data->tanggal_keluar, 'd F Y')); ?></td>
                                                        <?php endif; ?>
                                                        <td><?php echo e($data->pihak_penerima); ?></td>
                                                        <td><?php echo e($data->tim_kegiatan); ?></td>
                                                        <td class="text-right">
                                            ...
                                            <!-- Card footer -->
                                            <div class="card-footer py-4">
                                                <?php echo e($suratkeluarverified->links('vendor.pagination.bootstrap-4')); ?>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="card">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table align-items-center table-flush">
                                                    ...
                                                    <?php
                                                        $i = 1;
                                                    ?>
                                                    <?php $__currentLoopData = $suratkeluarrejected; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($data->desa_adat_id == Auth::user()->desa_adat_id): ?>
                                                    <tr>
                                                        <td> <?php echo e($i++); ?> </td>
                                                        <td><?php echo e($data->nomor_surat); ?></td>
                                            ...
                                            <!-- Card footer -->
                                            <div class="card-footer py-4">
                                                <?php echo e($suratkeluarrejected->links('vendor.pagination.bootstrap-4')); ?>
...
<?php /**PATH D:\Teknologi Informasi\Tugas Akhir\PROJECT\SirajaProject\SirajaProject\resources\views/admin/suratkeluar/suratPanitia/home-surat-panitia.blade.php ENDPATH**/ ?>