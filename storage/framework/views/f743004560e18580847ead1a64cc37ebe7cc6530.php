      ...
      <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card">
                ...
                <form action="<?php echo e(route('add-surat-keluar-panitia')); ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="master_surat" class="form-control" id="master_surat" style="height: 100%">
                                      ...
                                      <?php $__currentLoopData = $nomorsurat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          <option value="<?php echo e($data->master_surat_id); ?>" data-id="<?php echo e($data->kode_nomor_surat); ?>"><?php echo e($data->kode_nomor_surat); ?> - <?php echo e($data->keterangan); ?></option>
...
<?php /**PATH D:\Teknologi Informasi\Tugas Akhir\PROJECT\SirajaProject\SirajaProject\resources\views/admin/suratkeluar/suratPanitia/add-surat-panitia.blade.php ENDPATH**/ ?>