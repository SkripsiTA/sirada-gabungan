                      ...
                      <div class="pl-lg-4">
                          <div class="row">
                              ...
                              <div class="col-lg-12">
                                ...
                                <input type="file" name="file_sk" class="form-control" placeholder="File SK" value="<?php echo e($editprajurudesa->sk_prajuru); ?>">
                                </div>
                              </div>
                          </div>
                      </div>
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" class="form-control" id="email" placeholder="Email" value="<?php echo e($editprajurudesa->kramamipil->cacahkramamipil->penduduk->user[0]->email); ?>" required>
                                </div>
                            </div>
                            <div class="col-lg-4">
                              <div class="form-group">
                                  <label class="form-control-label" for="input-username">Nomor Telpon<i class="text-danger text-sm text-bold">*</i></label>
                                  <input type="text" name="nomor_telepon" class="form-control" id="nomor_telepon" placeholder="Nomor Telpon" value="<?php echo e($editprajurudesa->kramamipil->cacahkramamipil->penduduk->user[0]->nomor_telepon); ?>" required>
                              </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label" for="input-email">Password</label>
                                    <input type="password" name="password" class="password form-control" id="password" placeholder="Password" value="<?php echo e($editprajurudesa->kramamipil->cacahkramamipil->penduduk->user[0]->password); ?>" required>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select name="role_prajuru" class="form-control" id="role_prajuru" required>
                                        <option value="<?php echo e($editprajurudesa->kramamipil->cacahkramamipil->penduduk->user[0]->role); ?>" selected><?php echo e($editprajurudesa->kramamipil->cacahkramamipil->penduduk->user[0]->role); ?></option>
                                        <option value="Bendesa" <?= $editprajurudesa->desaadat->user[0]->role === 'Bendesa' ? 'selected' : '' ?>>Bendesa</option>
                                        <option value="Penyarikan" <?= $editprajurudesa->desaadat->user[0]->role === 'Penyarikan' ? 'selected' : '' ?>>Penyarikan</option>
...
<?php /**PATH D:\Teknologi Informasi\Tugas Akhir\PROJECT\SirajaProject\SirajaProject\resources\views/admin/masterdata/pegawai/edit-prajuru-desa.blade.php ENDPATH**/ ?>