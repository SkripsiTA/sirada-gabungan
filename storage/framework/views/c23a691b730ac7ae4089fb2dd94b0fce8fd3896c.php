...
<body>
  ...
  <div class="modal fade" id="formTolak" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <form action="<?php echo e(route('pendaftaran-desa-ditolak')); ?>" id="myForm" name="myForm" class="form-horizontal" method="POST" enctype="multipart/form-data">
            <?php echo e(csrf_field()); ?>
            ...
            <div class="modal-body">
                ...
                <input type="hidden" id="desa_adat_id" name="desa_adat_id" value="<?php echo e($desaadatpending->desa_adat_id); ?>">
                <div class="pl-lg-12">
                    <div class="row">
...
<?php /**PATH D:\Teknologi Informasi\Tugas Akhir\PROJECT\SirajaProject\SirajaProject\resources\views/superadmin/dashboard/konfirmasi-desa.blade.php ENDPATH**/ ?>