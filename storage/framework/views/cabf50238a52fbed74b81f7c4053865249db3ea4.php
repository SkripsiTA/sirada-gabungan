      ...
      <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card">
                ...
                <form action="<?php echo e(route('add-prajuru-desa-adat')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select name="role_prajuru" class="form-control" id="role_prajuru" required>
                                        ...
                                        <option value="Penyarikan" <?= $akun->role === 'Penyarikan' ? 'selected' : '' ?>>Penyarikan</option>
...
<?php /**PATH D:\Teknologi Informasi\Tugas Akhir\PROJECT\SirajaProject\SirajaProject\resources\views/admin/masterdata/pegawai/add-prajuru-desa.blade.php ENDPATH**/ ?>