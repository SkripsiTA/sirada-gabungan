                ...
                <div class="card-header">
                    <div class="col-lg-12">
                        ...
                        <div class="float-right">
                            <a href="<?php echo e(route('cetak-daftar-surat-keluar-non-panitia')); ?>" type="button" class="btn btn-md btn-danger" target="_blank"><i class="fa fa-print"></i>
                            PDF</a>
                            <a href="<?php echo e(route('create-surat-keluar-non-panitia')); ?>" type="button" class="btn btn-md btn-primary"><i class="fa fa-plus"></i>
                            Tambah</a>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <table class="table align-items-center table-flush">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <a href="<?php echo e(route('detail-surat-keluar-non-panitia', $data->surat_keluar_id)); ?>" class="btn btn-sm btn-flat btn-primary"><i class="fa fa-eye"></i></a>
                                                    </td>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table align-items-center table-flush">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            <a href="<?php echo e(route('detail-surat-keluar-non-panitia-inprogress', $data->surat_keluar_id)); ?>" class="btn btn-sm btn-flat btn-primary"><i class="fa fa-eye"></i></a>
                                                        </td>
...
<?php /**PATH D:\Teknologi Informasi\Tugas Akhir\PROJECT\SirajaProject\SirajaProject\resources\views/admin/suratkeluar/suratNonPanitia/home-surat-non-panitia.blade.php ENDPATH**/ ?>