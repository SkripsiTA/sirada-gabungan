                        ...
                        <table class="table align-items-left table-flush" style="border: 2px solid black;">
                            ...
                            <?php $__currentLoopData = $suratmasuk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr style="border: 2px solid black;">
                                    ...
                                    <td style="border: 2px solid; color:#444444;"> <?php echo e($data->perihal); ?> </td>
                                    <?php if($data->tanggal_surat != null): ?>
                                        <td style="border: 2px solid; color:#444444;"> <?php echo e(showDateTime($data->tanggal_surat, 'd F Y')); ?></td>
                                    <?php else: ?>
                                        <td style="border: 2px solid; color:#444444;"><?php echo e($data->tanggal_surat); ?></td>
                                    <?php endif; ?>
                                    <td style="border: 2px solid; color:#444444;"> <?php echo e($data->asal_surat); ?> </td>
                                    <td style="border: 2px solid; color:#444444;"><?php echo e(showDateTime($data->tanggal_diterima, 'd F Y')); ?></td>
                                    <td style="border: 2px solid; color:#444444;"> <?php echo e($data->prajurudesaadat->kramamipil->cacahkramamipil->penduduk->nama); ?> </td>
                                </tr>
...
<?php /**PATH D:\Teknologi Informasi\Tugas Akhir\PROJECT\SirajaProject\SirajaProject\resources\views/admin/suratmasuk/cetak-daftar-surat-masuk.blade.php ENDPATH**/ ?>