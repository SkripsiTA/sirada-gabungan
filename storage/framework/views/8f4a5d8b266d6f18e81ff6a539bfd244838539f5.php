                      ...
                      <div class="pl-lg-4">
                          <div class="row">
                              <div class="col-lg-12">
                                  <div class="form-group">
                                      ...
                                      <select name="kramamipil_id" class="kramamipil_id form-control" id="kramamipil_id" style="height: 100%" disabled>
                                        <option value="<?php echo e($detailprajurubanjar->krama_mipil_id); ?>"><?php echo e($detailprajurubanjar->kramamipil->cacahkramamipil->penduduk->nik); ?> - <?php echo e($detailprajurubanjar->kramamipil->cacahkramamipil->penduduk->nama); ?></option>
                              ...
                              <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select name="nama_jabatan" class="form-control" id="nama_jabatan" disabled>
                                        <option value="<?php echo e($detailprajurubanjar->jabatan); ?>"><?php echo e($detailprajurubanjar->jabatan); ?></option>
                              ...
                              <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select name="status_prajuru_banjar" class="form-control" id="status_prajuru_banjar" disabled>
                                        <option value="<?php echo e($detailprajurubanjar->status_prajuru_banjar_adat); ?>"><?php echo e($detailprajurubanjar->status_prajuru_banjar_adat); ?></option>
                              ...
                              <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select name="banjar_adat" class="form-control" id="banjar_adat" disabled>
                                        <option value="<?php echo e($detailprajurubanjar->banjar_adat_id); ?>" selected><?php echo e($detailprajurubanjar->banjaradat->nama_banjar_adat); ?></option>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="masa_mulai" placeholder="Periode Mulai" type="text" value="<?php echo e(showDateTime($detailprajurubanjar->tanggal_mulai_menjabat, 'd F Y')); ?>" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="masa_berakhir" placeholder="Periode Berakhir" type="text" value="<?php echo e(showDateTime($detailprajurubanjar->tanggal_akhir_menjabat, 'd F Y')); ?>" disabled>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                              ...
                              <div class="col-lg-12">
                                ...
                                <input type="text" name="file_sk" class="form-control" placeholder="SK Prajuru Desa Adat" value="<?php echo e($detailprajurubanjar->sk_prajuru_banjar); ?>" disabled><iframe src="<?php echo e(asset('assets/img/SK/'.$detailprajurubanjar->sk_prajuru_banjar )); ?>"  height="500px" width="100%" style="margin-Top :5px;"></iframe>
                                </div>
                              </div>
                          </div>
                      </div>
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" class="form-control" id="email" placeholder="Email" value="<?php echo e($detailprajurubanjar->kramamipil->cacahkramamipil->penduduk->user[0]->email); ?>" disabled>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="input-username">Nomor Telpon<i class="text-danger text-sm text-bold">*</i></label>
                                    <input type="text" name="nomor_telepon" class="form-control" id="nomor_telepon" placeholder="Nomor Telpon" value="<?php echo e($detailprajurubanjar->kramamipil->cacahkramamipil->penduduk->user[0]->nomor_telepon); ?>" readonly>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    
                                    <input type="hidden" name="password" class="password form-control" id="password" placeholder="Password" value="<?php echo e($detailprajurubanjar->kramamipil->cacahkramamipil->penduduk->user[0]->password); ?>" disabled>
                                </div>
                            </div>
                        </div>
                      </div>
...
<?php /**PATH D:\Teknologi Informasi\Tugas Akhir\PROJECT\SirajaProject\SirajaProject\resources\views/admin/masterdata/banjar/detail-prajuru-banjar.blade.php ENDPATH**/ ?>