      ...
      <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card">
                ...
                <form action="<?php echo e(route('detail-prajuru-desa-adat', $detailprajurudesa->prajuru_desa_adat_id)); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                      ...
                      <div class="pl-lg-4">
                          <div class="row">
                              <div class="col-lg-12">
                                  <div class="form-group">
                                      ...
                                      <select name="kramamipil_id" class="kramamipil_id form-control" id="kramamipil_id" style="height: 100%" disabled>
                                        <option value="<?php echo e($detailprajurudesa->krama_mipil_id); ?>"><?php echo e($detailprajurudesa->kramamipil->cacahkramamipil->penduduk->nik); ?> - <?php echo e($detailprajurudesa->kramamipil->cacahkramamipil->penduduk->nama); ?></option>
                              ...
                              <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select name="nama_jabatan" class="form-control" id="nama_jabatan" readonly>
                                        <option value="<?php echo e($detailprajurudesa->jabatan); ?>"><?php echo e($detailprajurudesa->jabatan); ?></option>
                              ...
                              <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select name="status_prajuru_desa" class="form-control" id="status_prajuru_desa" readonly>
                                        <option value="<?php echo e($detailprajurudesa->status_prajuru_desa_adat); ?>"><?php echo e($detailprajurudesa->status_prajuru_desa_adat); ?></option>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="masa_mulai" placeholder="Periode Mulai" type="text" value="<?php echo e(showDateTime($detailprajurudesa->tanggal_mulai_menjabat, 'd F Y')); ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="masa_berakhir" placeholder="Periode Berakhir" type="text" value="<?php echo e(showDateTime($detailprajurudesa->tanggal_akhir_menjabat, 'd F Y')); ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                              ...
                              <div class="col-lg-12">
                                <div class="form-group">
                                <label class="form-control-label" for="input-country">SK Prajuru Desa Adat<i class="text-danger text-sm text-bold">*</i></label>
                                <input type="text" name="file_sk" class="form-control" placeholder="SK Prajuru Desa Adat" value="<?php echo e($detailprajurudesa->sk_prajuru); ?>" disabled><iframe src="<?php echo e(asset('assets/img/SK/'.$detailprajurudesa->sk_prajuru )); ?>"  height="500px" width="100%" style="margin-Top :5px;"></iframe>
                                </div>
                              </div>
                          </div>
                      </div>
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" class="form-control" id="email" placeholder="Email" value="<?php echo e($detailprajurudesa->kramamipil->cacahkramamipil->penduduk->user[0]->email); ?>" readonly>
                                </div>
                            </div>
                            <div class="col-lg-4">
                              <div class="form-group">
                                  <label class="form-control-label" for="input-username">Nomor Telpon<i class="text-danger text-sm text-bold">*</i></label>
                                  <input type="text" name="nomor_telepon" class="form-control" id="nomor_telepon" placeholder="Nomor Telpon" value="<?php echo e($detailprajurudesa->kramamipil->cacahkramamipil->penduduk->user[0]->nomor_telepon); ?>" readonly>
                              </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label" for="input-email">Password</label>
                                    <input type="password" name="password" class="password form-control" id="password" placeholder="Password" value="<?php echo e($detailprajurudesa->kramamipil->cacahkramamipil->penduduk->user[0]->password); ?>" readonly>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select name="role_prajuru" class="form-control" id="role_prajuru" readonly>
                                        <option value="<?php echo e($detailprajurudesa->desaadat->user[0]->role); ?>" selected><?php echo e($detailprajurudesa->kramamipil->cacahkramamipil->penduduk->user[0]->role); ?></option>
...
<?php /**PATH D:\Teknologi Informasi\Tugas Akhir\PROJECT\SirajaProject\SirajaProject\resources\views/admin/masterdata/pegawai/detail-prajuru-desa.blade.php ENDPATH**/ ?>