                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <?php if($data->status_prajuru_desa_adat == 'aktif'): ?>
                                                                <a href="<?php echo e(route('detail-prajuru-desa-adat', $data->prajuru_desa_adat_id)); ?>" class="view btn btn-sm btn-flat btn-info"><i class="fa fa-eye"></i></a>
                                                            ...
                                                            <?php else: ?>
                                                                <a href="<?php echo e(route('detail-prajuru-desa-adat', $data->prajuru_desa_adat_id)); ?>" class="view btn btn-sm btn-flat btn-info"><i class="fa fa-eye"></i></a>
                                                                <button type="submit" class="btn btn-sm btn-flat btn-success aktif" data-id="<?php echo e($data->prajuru_desa_adat_id); ?>"><i class="fa fa-toggle-on"></i></button>
                                                            <?php endif; ?>
...
<?php /**PATH D:\Teknologi Informasi\Tugas Akhir\PROJECT\SirajaProject\SirajaProject\resources\views/admin/masterdata/pegawai/prajuru-desa.blade.php ENDPATH**/ ?>