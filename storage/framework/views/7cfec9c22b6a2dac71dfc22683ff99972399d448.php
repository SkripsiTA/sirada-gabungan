                                                ...
                                                <?php $__currentLoopData = $prajurubanjar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <?php if($data->status_prajuru_banjar_adat == 'aktif'): ?>
                                                                <a href="<?php echo e(route('detail-prajuru-banjar-adat', $data->prajuru_banjar_adat_id)); ?>" class="view btn btn-sm btn-flat btn-info"><i class="fa fa-eye"></i></a>
                                                                <a href="<?php echo e(route('edit-prajuru-banjar-adat', $data->prajuru_banjar_adat_id)); ?>" class="btn btn-sm btn-flat btn-warning"><i class="fa fa-edit"></i></a>
                                                                <button type="submit" class="btn btn-sm btn-flat btn-danger nonaktif" data-id="<?php echo e($data->prajuru_banjar_adat_id); ?>"><i class="fa fa-toggle-off"></i></button>
                                                            <?php else: ?>
                                                                <a href="<?php echo e(route('detail-prajuru-banjar-adat', $data->prajuru_banjar_adat_id)); ?>" class="view btn btn-sm btn-flat btn-info"><i class="fa fa-eye"></i></a>
                                                                <button type="submit" class="btn btn-sm btn-flat btn-success aktif" data-id="<?php echo e($data->prajuru_banjar_adat_id); ?>"><i class="fa fa-toggle-on"></i></button>
                                                            <?php endif; ?>
                                                        </td>
                                                    </tr>
                                                    <?php endif; ?>
...
<?php /**PATH D:\Teknologi Informasi\Tugas Akhir\PROJECT\SirajaProject\SirajaProject\resources\views/admin/masterdata/banjar/prajuru-banjar.blade.php ENDPATH**/ ?>