                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                              ...
                              <input type="text" name="nama_ayah" class="form-control" placeholder="Ayah" value="<?php echo e(Auth::user()->penduduk->ayahkandung->nama ?? "Tidak Diketahui"); ?>" disabled>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                              <label class="form-control-label" for="input-country">Ibu</label>
                              <input type="text" name="nama_ibu" class="form-control" placeholder="Ibu" value="<?php echo e(Auth::user()->penduduk->ibukandung->nama ?? "Tidak Diketahui"); ?>" disabled>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH D:\Teknologi Informasi\Tugas Akhir\PROJECT\SirajaProject\SirajaProject\resources\views/profile/profile.blade.php ENDPATH**/ ?>