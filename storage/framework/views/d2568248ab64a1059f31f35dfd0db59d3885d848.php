      ...
      <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card">
                ...
                <form action="<?php echo e(route('add-prajuru-banjar-adat')); ?>" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="pl-lg-4">
                          <div class="row">
                              ...
                              <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select name="nama_jabatan" class="form-control" id="nama_jabatan" required>
                                        ...
                                        <option value="kelihan_adat">Kelihan Banjar</option>
                                        <option value="pangliman_banjar">Pangliman</option>
                                        <option value="penyarikan_banjar">Penyarikan</option>
                                        <option value="patengen_banjar">Patengen</option>
                                    </select>
                                </div>
                              </div>
                              <div class="col-lg-4">
                              ...
                              <div class="col-lg-12">
                                ...
                                <input type="file" name="file_sk" class="form-control" placeholder="File SK" value="" required>
                                </div>
                              </div>
                          </div>
                      </div>
...
<?php /**PATH D:\Teknologi Informasi\Tugas Akhir\PROJECT\SirajaProject\SirajaProject\resources\views/admin/masterdata/banjar/add-prajuru-banjar.blade.php ENDPATH**/ ?>