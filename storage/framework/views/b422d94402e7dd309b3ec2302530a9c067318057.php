        ...
        <div class="col-xl-12 order-xl-1">
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-2 float-right">
                            <a href="<?php echo e(route('edit-surat-keluar-panitia', $suratkeluarpanitia->surat_keluar_id)); ?>" class="btn btn-sm btn-flat btn-primary"><i class="fa fa-edit"></i></a>
                            <a href="<?php echo e(route('cetak-surat-keluar-panitia', $suratkeluarpanitia->surat_keluar_id)); ?>" class="btn btn-sm btn-flat btn-primary" target="_blank"><i class="fa fa-print "></i></a>
                            <button href="#" data-id="<?php echo e($suratkeluarpanitia->surat_keluar_id); ?> type="submit" class="btn btn-sm btn-flat btn-primary inprogress"><i class="fa fa-spinner"></i></button>
                        ...
                        <tr>
                            <td colspan="2">
                                <?php if($suratkeluarpanitia->pamahbah_surat != null): ?>
                                    <p align="justify" size="3" style="font-family: TimesNewRoman; color:#444444;" class="justify"><span class="tab"></span><?php echo e($suratkeluarpanitia->pamahbah_surat); ?></p><br><br>
                                <?php endif; ?>
                                ...
                                <?php if($suratkeluarpanitia->pamuput_surat != null): ?>
                                    <br><p align="justify" size="3" style="font-family: TimesNewRoman; color:#444444;" class="justify"><span class="tab"></span><?php echo e($suratkeluarpanitia->pamuput_surat); ?></p><br><br>
                                <?php endif; ?>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                ...
                                <font size="3" class="font-weight-bold" style="font-family: TimesNewRoman;" color="#444444"><?php echo e($suratkeluarpanitia->tim_kegiatan); ?></font><br><br><br>
                            </td>
                        </tr>
                        <tr>
                            <td>
                ...
                <div class="card-footer text-right">
                    <a href="<?php echo e(route('home-surat-keluar-panitia')); ?>" type="button" class="btn btn-warning float-left">Batal</a>
                    <a href="<?php echo e(route('lampiran-surat-keluar-panitia', $suratkeluarpanitia->surat_keluar_id)); ?>" type="button" class="btn btn-info float-right">Lepihan</a>
                </div>
            </div>
        </div>
      </div>
...
<?php /**PATH D:\Teknologi Informasi\Tugas Akhir\PROJECT\SirajaProject\SirajaProject\resources\views/admin/suratkeluar/suratPanitia/detail-surat-panitia.blade.php ENDPATH**/ ?>