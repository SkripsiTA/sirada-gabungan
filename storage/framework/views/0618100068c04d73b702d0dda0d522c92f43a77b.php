                          ...
                          <div class="row">
                              ...
                              <div class="col-lg-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nomor_surat_masuk" class="form-control" id="nomor_surat_masuk" placeholder="Nomor Surat" value="<?php echo e($suratmasuk->nomor_surat); ?>" readonly>
                                </div>
                              </div>
                              <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label" for="input-email">Parindikan</label>
                                    <input type="text" name="parindikan" class="form-control" id="parindikan" placeholder="Parindikan" value="<?php echo e($suratmasuk->perihal); ?>" readonly>
                                </div>
                              </div>
                              <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label" for="input-email">Mawit Saking</label>
                                    <input type="text" name="mawit_saking" class="form-control" id="mawit_saking" placeholder="Mawit Saking" value="<?php echo e($suratmasuk->asal_surat); ?>" readonly>
                                </div>
                              </div>
                              <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="tanggal_surat" class="form-control datepicker1" placeholder="Tanggal Surat" type="text" value="<?php if($suratmasuk->tanggal_surat != null): ?><?php echo e(showDateTime($suratmasuk->tanggal_surat, 'd F Y')); ?><?php endif; ?>" readonly>
                                    </div>
                                </div>
                              </div>
                              <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="tanggal_diterima" class="form-control datepicker1" placeholder="Tanggal Masuk" type="text" value="<?php echo e(showDateTime($suratmasuk->tanggal_diterima, 'd F Y')); ?>" readonly>
                                    </div>
                                </div>
                              </div>
                          </div>
                        ...
                        <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" name="tanggal_kegiatan_mulai" placeholder="Tanggal Kegiatan Mulai" type="text" value="<?php echo e(showDateTime($suratmasuk->tanggal_kegiatan_mulai, 'd F Y')); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" name="tanggal_kegiatan_berakhir" placeholder="Tanggal Kegiatan Selesai" type="text" value="<?php echo e(showDateTime($suratmasuk->tanggal_kegiatan_berakhir, 'd F Y')); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                          ...
                          <div class="col-lg-4">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        <input type="time" name="waktu_kegiatan_mulai" class="form-control" id="waktu_kegiatan" placeholder="Waktu Kegiatan Mulai" value="<?php echo e($suratmasuk->waktu_kegiatan_mulai); ?>" readonly>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <input type="time" name="waktu_kegiatan_berakhir" class="form-control" id="waktu_kegiatan" placeholder="Waktu Kegiatan Selesai" value="<?php echo e($suratmasuk->waktu_kegiatan_berakhir); ?>" readonly>
                                    </div>
                                </div>
                            </div>
                          </div>
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="prajuru_desa_adat" class="form-control" id="prajuru_desa_adat" placeholder="Prajuru Desa Adat" value="<?php echo e($suratmasuk->prajurudesaadat->kramamipil->cacahkramamipil->penduduk->nama); ?>" readonly>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="input-email">Jabatan</label>
                                    <input type="text" name="jabatan" class="form-control" id="jabatan" placeholder="Jabatan" value="<?php echo e($suratmasuk->prajurudesaadat->jabatan); ?>" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <a href="<?php echo e(route('file-surat-masuk', $suratmasuk->surat_masuk_id)); ?>" type="button" class="btn btn-primary btn-lg btn-block">Detail File</a>
                            </div>
                          </div>
                      </div>
                    </div>
...
<?php /**PATH D:\Teknologi Informasi\Tugas Akhir\PROJECT\SirajaProject\SirajaProject\resources\views/admin/suratmasuk/detail-surat-masuk.blade.php ENDPATH**/ ?>