...
Route::post('autentikasi/login/token', [LoginController::class, 'insert_fcm_token']);
Route::post('autentikasi/login/token/remove', [LoginController::class, 'remove_fcm_token']);
...
Route::get('data/nomorsurat', [NomorSuratController::class, 'show_all_master_surat']);
...
//send notifikasi
Route::get('notifikasi/send', [NotificationController::class, 'send_notification']);
